...
def run(train=True,model_name="model",epochs=50,steps=500,ard=True):
    if ard:
    ...
    for e in range(epochs):
        ...
        print(f"epoch: {e}")
        # select_lane = [
        #     ["GGggrrrrGGggrrrr", "rrrrGGggrrrrGGgg"],
        ...
        for junction_number, junction in enumerate(all_junctions):
            ...
            #o prev_vehicles_per_lane[junction_number] = [0] * (len(all_junctins) * 4) 
